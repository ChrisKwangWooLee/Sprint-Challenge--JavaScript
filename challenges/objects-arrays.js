...
const universities = graduates.map(el => {
...
const unisWithUni = graduates.filter(el=> {
...
*/
const lowCaseAnimalNames = zooAnimals.map(el => {
...
*/
const lowPopulationAnimals = zooAnimals.filter(el => {
...
*/
const populationTotal = zooAnimals.reduce((accumulator, el) => {
  return accumulator += el.population;
},0)
